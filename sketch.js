...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(keyDown("space") && trex.y >= windowHeight-50|| touches.length > 0 ) {
      trex.velocityY = -12;
      touches = [];
    }
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(windowWidth-50,windowHeight-300,40,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(windowWidth-50,windowHeight-40,10,40);
    //obstacle.debug = true;
